...
protocol CasheSettingsViewDelegate: AnyObject {
    func didTapCashe()
}

final class CasheSettingsView: UIControl {
    weak var delegate: CasheSettingsViewDelegate?
    ...
    init(delegate: CasheSettingsViewDelegate) {
    ...
    private func drawSelf() {
        ...
        typeImageView.image = UIImage(named: "set_cashe_icon")
