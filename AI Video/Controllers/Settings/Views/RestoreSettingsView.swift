...
protocol RestoreSettingsViewDelegate: AnyObject {
    func didTapRestore()
}

final class RestoreSettingsView: UIControl {
    weak var delegate: RestoreSettingsViewDelegate?
    ...
    init(delegate: RestoreSettingsViewDelegate) {
    ...
    private func drawSelf() {
        ...
        typeImageView.image = UIImage(named: "set_restore_icon")
